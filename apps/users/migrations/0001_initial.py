    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('karma', models.IntegerField(default=0, help_text="Points de réputation : somme des scores des posts et des commentaires publiés par l'utilisateur (mise à jour par signaux).", verbose_name='karma')),
